...
export const storyChapters: StoryChapter[] = [
	{
		...
		nodes: [
			...
			},
			{
				id: "meet_sadie",
				type: "paragraph",
				text: "A few hours later, you wake to the sound of the medical bay door hissing open...",
				npcUpdates: [
					{
						npcId: 'sadie',
						locationId: 'crew-quarters',
						message: 'Sadie Thompson has arrived on the Prospector'
					}
				],
				media: {
					character: {
			...
			{
				type: "paragraph",
				text: "She stands, gathering her coat. \"Account details,\" she states simply. \"You'll find the funds waiting. If you need advice, or someone to keep you from getting scammed out of your newfound fortune, you can find me on Ceres. I need to take my skiff back now we know there isn't an immediate threat.\"",
				npcUpdates: [
					{
						npcId: 'sadie',
						locationId: 'ceres',
						message: 'Sadie has returned to Ceres'
					}
				]
			}
		]
